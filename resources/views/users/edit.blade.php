...
@section('title')
    {{trans('admin/user.user_edit')}} -{{trans('admin/news.around_theworld')}}
@stop
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{trans('admin/user.users')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"> / {{trans('admin/user.user_edit')}}  </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row row-sm mg-b-20">
                        <div class="col-lg-6">
                            ...
                            <select name="Status" id="select-beast" class="form-control  nice-select  custom-select">
                                ...
                                <option value="مفعل">{{trans('admin/user.enable')}}</option>
                                <option value="غير مفعل"> {{trans('admin/user.unenable')}}</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mg-b-20">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong>{{trans('admin/user.roles_user')}}</strong>
                    ...
                    <div class="mg-t-30">
                        <button class="btn btn-main-primary pd-x-20" type="submit">{{trans('admin/user.edit')}}</button>
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
